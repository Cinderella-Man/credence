defmodule Credence.Syntax.CloseUnclosedFnDelimiterAnalyzeTest do
  ...
  test "flags code where fn is missing its closing end before ) with a stray end" do
    code = """
  ...
  test "stays silent on a plain unclosed fn (no stray end) — NoUnclosedFnDelimiter owns it" do
