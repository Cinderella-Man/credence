defmodule Credence.Pattern.NoLengthComparisonForEmptyCheckTest do
  ...
  describe "flags equality" do
    ...
    test "length(l) == 3" do
      assert [%Issue{}] = check(NoLengthComparisonForEmpty, "length(l) == 3")
    end

    test "length(l) == 5" do
      assert [%Issue{}] = check(NoLengthComparisonForEmpty, "length(l) == 5")
    end

    test "length(l) != 0" do
      assert [%Issue{}] = check(NoLengthComparisonForEmpty, "length(l) != 0")
    end

    test "length(l) != 2" do
      assert [%Issue{}] = check(NoLengthComparisonForEmpty, "length(l) != 2")
    end
  end
  ...
  describe "flags fewer-than-N" do
    test "length(l) < 1" do
      assert [%Issue{}] = check(NoLengthComparisonForEmpty, "length(l) < 1")
    end
  ...
  describe "flags reversed operands" do
    test "0 == length(l)" do
      assert [%Issue{}] = check(NoLengthComparisonForEmpty, "0 == length(l)")
    end

    test "2 <= length(l)" do
      assert [%Issue{}] = check(NoLengthComparisonForEmpty, "2 <= length(l)")
    end
  ...
  describe "metadata" do
    test "meta.line is set" do
      [issue] = check(NoLengthComparisonForEmpty, "length(l) == 0")
