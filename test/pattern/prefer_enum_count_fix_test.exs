defmodule Credence.Pattern.PreferEnumCountFixTest do
  ...
  describe "fix" do
    ...
    test "does not modify reduce whose condition references the accumulator" do
      code = """
      Enum.reduce(list, 0, fn x, acc ->
    ...
    test "does not modify reduce whose condition ignores the element" do
      code = """
      Enum.reduce(list, 0, fn x, acc ->
    ...
    test "does not modify reduce whose condition contains a capture" do
      code = """
      Enum.reduce(list, 0, fn x, acc ->
