...
#
# Strip the current set's lines from maintainer_tools/unfixable_unreviewed.md — the rule line plus its
...
#
# Anchor = the first non-blank line of unfixable_unreviewed.md (the rule file), unless a
...
[[ -n "$anchor" ]] || { echo "unfixable_unreviewed.md empty — nothing to remove."; exit 0; }
...
echo "removed $((before - after)) line(s) for set '${base}', kept files; ${after} left in unfixable_unreviewed.md."
