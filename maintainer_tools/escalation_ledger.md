...
*Patch:* `maintainer_tools/199-no_negative_step_in_string_slice.patch` — copied out of `var/archive/run-2026-07-06/escalated/199.patch` on 2026-08-17 (md5 `84655fb6…`, both harness copies identical) because `var/` is gitignored and is dropped between evolutions. It adds four new files: the rule plus its check/fix/equivalence tests.
